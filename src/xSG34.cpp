...
boolean xSG34::begin(TwoWire &wirePort, uint32_t i2cSpeed, uint8_t i2caddr) {
...
void xSG34::softReset(void) {
  ...
  {
    uint8_t response = xCore.read8(_i2caddr, MAX30105_MODECONFIG);
    if ((response & MAX30105_RESET) == 0) break; //We're done!
    delay(1); //Let's not over burden the I2C bus
  }
}

void xSG34::shutDown(void) {
...
void xSG34::wakeUp(void) {
  // Pull IC out of low power mode (datasheet pg. 19)
  bitMask(MAX30105_MODECONFIG, MAX30105_SHUTDOWN_MASK, MAX30105_WAKEUP);
}

void xSG34::setLEDMode(uint8_t mode) {
  // Set which LEDs are used for sampling -- Red only, RED+IR only, or custom.
  // See datasheet, page 19
  bitMask(MAX30105_MODECONFIG, MAX30105_MODE_MASK, mode);
}

void xSG34::setADCRange(uint8_t adcRange) {
  // adcRange: one of MAX30105_ADCRANGE_2048, _4096, _8192, _16384
  bitMask(MAX30105_PARTICLECONFIG, MAX30105_ADCRANGE_MASK, adcRange);
}

void xSG34::setSampleRate(uint8_t sampleRate) {
  // sampleRate: one of MAX30105_SAMPLERATE_50, _100, _200, _400, _800, _1000, _1600, _3200
  bitMask(MAX30105_PARTICLECONFIG, MAX30105_SAMPLERATE_MASK, sampleRate);
}

void xSG34::setPulseWidth(uint8_t pulseWidth) {
...
void xSG34::setPulseAmplitudeRed(uint8_t amplitude) {
  xCore.write8(_i2caddr, MAX30105_LED1_PULSEAMP, amplitude);
}

void xSG34::setPulseAmplitudeIR(uint8_t amplitude) {
  xCore.write8(_i2caddr, MAX30105_LED2_PULSEAMP, amplitude);
}

void xSG34::setPulseAmplitudeGreen(uint8_t amplitude) {
  xCore.write8(_i2caddr, MAX30105_LED3_PULSEAMP, amplitude);
}

void xSG34::setPulseAmplitudeProximity(uint8_t amplitude) {
  xCore.write8(_i2caddr, MAX30105_LED_PROX_AMP, amplitude);
}

void xSG34::setProximityThreshold(uint8_t threshMSB) {
  // Set the IR ADC count that will trigger the beginning of particle-sensing mode.
  // The threshMSB signifies only the 8 most significant-bits of the ADC count.
  // See datasheet, page 24.
  xCore.write8(_i2caddr, MAX30105_PROXINTTHRESH, threshMSB);
}
...
void xSG34::enableSlot(uint8_t slotNumber, uint8_t device) {
...
int32_t xSG34::getSPO2()
{
	return spo2;
}

int8_t xSG34::isSPO2Valid()
{
	return validSPO2;
}
...
int32_t xSG34::getirBuffer()
{
	return irBuffer[0];
}

//Clears all slot assignments
void xSG34::disableSlots(void) {
  xCore.write8(_i2caddr, MAX30105_MULTILEDCONFIG1, 0);
  xCore.write8(_i2caddr, MAX30105_MULTILEDCONFIG2, 0);
}
...
void xSG34::setFIFOAverage(uint8_t numberOfSamples) {
  bitMask(MAX30105_FIFOCONFIG, MAX30105_SAMPLEAVG_MASK, numberOfSamples);
}

//Resets all points to start in a known state
//Page 15 recommends clearing FIFO before beginning a read
void xSG34::clearFIFO(void) {
  xCore.write8(_i2caddr, MAX30105_FIFOWRITEPTR, 0);
  xCore.write8(_i2caddr, MAX30105_FIFOOVERFLOW, 0);
  xCore.write8(_i2caddr, MAX30105_FIFOREADPTR, 0);
}

//Enable roll over if FIFO over flows
void xSG34::enableFIFORollover(void) {
  bitMask(MAX30105_FIFOCONFIG, MAX30105_ROLLOVER_MASK, MAX30105_ROLLOVER_ENABLE);
}

//Disable roll over if FIFO over flows
void xSG34::disableFIFORollover(void) {
...
void xSG34::setFIFOAlmostFull(uint8_t numberOfSamples) {
  bitMask(MAX30105_FIFOCONFIG, MAX30105_A_FULL_MASK, numberOfSamples);
}

//Read the FIFO Write Pointer
uint8_t xSG34::getWritePointer(void) {
  return (xCore.read8(_i2caddr, MAX30105_FIFOWRITEPTR));
}

//Read the FIFO Read Pointer
uint8_t xSG34::getReadPointer(void) {
  return (xCore.read8(_i2caddr, MAX30105_FIFOREADPTR));
}


// Die Temperature
// Returns temp in C
float xSG34::readTemperature() {
	
  //DIE_TEMP_RDY interrupt must be enabled
  //See issue 19: https://github.com/sparkfun/SparkFun_MAX3010x_Sensor_Library/issues/19
  
  // Step 1: Config die temperature register to take 1 temperature sample
  xCore.write8(_i2caddr, MAX30105_DIETEMPCONFIG, 0x01);
...
void xSG34::setPROXINTTHRESH(uint8_t val) {
  xCore.write8(_i2caddr, MAX30105_PROXINTTHRESH, val);
}
...
//
uint8_t xSG34::readPartID() {
  return xCore.read8(_i2caddr, MAX30105_PARTID);
}

void xSG34::readRevisionID() {
  revisionID = xCore.read8(_i2caddr, MAX30105_REVISIONID);
}

uint8_t xSG34::getRevisionID() {
  return revisionID;
}
...
void xSG34::setup(byte powerLevel, byte sampleAverage, byte ledMode, int sampleRate, int pulseWidth, int adcRange) {
...
uint32_t xSG34::getFIFORed(void)
{
  return (sense.red[sense.tail]);
}

//Report the next IR value in the FIFO
uint32_t xSG34::getFIFOIR(void)
{
  return (sense.IR[sense.tail]);
}

//Report the next Green value in the FIFO
uint32_t xSG34::getFIFOGreen(void)
{
  return (sense.green[sense.tail]);
}

//Advance the tail
void xSG34::nextSample(void)
{
...
uint16_t xSG34::check(void)
{
  ...
  if (readPointer != writePointer)
  {
    ...
    _i2cPort->beginTransmission(SG34_ADDRESS);
    ...
    while (bytesLeftToRead > 0)
    {
      ...
      _i2cPort->requestFrom(SG34_ADDRESS, toGet);
...
bool xSG34::safeCheck(uint8_t maxTimeToCheck)
{
...
void xSG34::bitMask(uint8_t reg, uint8_t mask, uint8_t thing)
{
  // Grab current register context
  uint8_t originalContents = xCore.read8(_i2caddr, reg);

  // Zero-out the portions of the register we're interested in
  originalContents = originalContents & mask;

  // Change contents
  xCore.write8(_i2caddr, reg, originalContents | thing);
}